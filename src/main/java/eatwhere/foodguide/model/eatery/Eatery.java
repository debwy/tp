...
public class Eatery {
     ...
     */
    public Eatery(Name name, Price price, Cuisine cuisine, Location location, Set<Tag> tags, Remark remark) {
        CollectionUtil.requireAllNonNull(name, price, cuisine, location, tags, remark);
        this.name = name;
        this.price = price;
